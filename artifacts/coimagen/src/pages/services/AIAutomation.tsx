...
const content: ServiceContent = {
  ...
  faq: [
    ...
    { q: { es: "¿Pueden automatizar WhatsApp?", en: "Can you automate WhatsApp?" }, a: { es: "Sí. Conectamos un asistente inteligente con IA que responde en WhatsApp de forma automática — atiende preguntas frecuentes, califica prospectos y da seguimiento, de forma profesional y dentro de las políticas de Meta.", en: "Yes. We connect a smart AI assistant that automatically responds on WhatsApp — answering common questions, qualifying leads, and following up, professionally and within Meta's policies." } },
