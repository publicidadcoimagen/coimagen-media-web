...
import {
  ...
  Brain, Settings, TrendingUp, MessageSquare, Menu, X,
  Stethoscope, Scale, PawPrint, Scissors, UtensilsCrossed,
  Building2, ShoppingBag, Bot, BarChart3, Workflow, Database
} from "lucide-react";
...
const t = {
  es: {
    ...
    hero: {
      ...
      subtitle:
        "Descubre las oportunidades digitales que están frenando el crecimiento de tu negocio. Solicita un Diagnóstico Digital Gratuito y conoce qué puedes mejorar para atraer más clientes.",
    ...
    solution: {
      title: "Coimagen transforma tu presencia digital en un sistema de crecimiento.",
      desc: "No vendemos solo páginas web. Creamos sistemas digitales para captar prospectos, automatizar procesos y ayudar a negocios a crecer con marketing, IA y automatización.",
      features: [
    ...
    diagnostic: {
      ...
      questions: [
        {
          q: "¿Tu negocio tiene sitio web?",
          opts: ["Sí", "No"],
        },
        {
          q: "¿Tu sitio web genera clientes regularmente?",
          opts: ["Sí", "No", "No estoy seguro"],
        },
        {
          q: "¿Tu negocio aparece en Google Maps o Google Business?",
          opts: ["Sí", "No", "No sé"],
        },
        {
          q: "¿Publicas contenido en redes sociales de forma constante?",
          opts: ["Sí", "No"],
        },
        {
          q: "¿Cuál es tu mayor desafío?",
          opts: ["Conseguir más clientes", "Mejorar presencia digital", "Automatizar procesos", "Vender más", "Otro"],
        },
      ],
      resultTitle: "Tu negocio tiene oportunidades digitales no aprovechadas.",
      resultDesc: "Solicita tu Diagnóstico Digital Gratuito completo y descubre exactamente qué puedes mejorar para atraer más clientes.",
    ...
    footer: {
      ...
      links: ["Servicios", "Diagnóstico", "Portafolio", "Contacto"],
  ...
  en: {
    ...
    hero: {
      title: "Is your business losing clients and you don't know why?",
      subtitle:
        "Discover the digital opportunities holding back your business growth. Request a Free Digital Diagnostic and learn what you can improve to attract more customers.",
      cta1: "Request Free Diagnostic",
      cta2: "View Services",
    },
    pain: {
    ...
    solution: {
      title: "Coimagen transforms your digital presence into a growth system.",
      desc: "We don't just sell websites. We create digital systems to capture prospects, automate processes, and help businesses grow with marketing, AI, and automation.",
      features: [
        ...
        { title: "CRM & Prospects", desc: "Smart tracking of every opportunity." },
      ],
    },
    diagnostic: {
      title: "Free Digital Diagnostic",
      subtitle: "Answer 5 questions and discover the opportunities your business is missing.",
      questions: [
        {
          q: "Does your business have a website?",
          opts: ["Yes", "No"],
        },
        {
          q: "Does your website generate clients regularly?",
          opts: ["Yes", "No", "Not sure"],
        },
        {
          q: "Does your business appear on Google Maps or Google Business?",
          opts: ["Yes", "No", "I don't know"],
        },
        {
          q: "Do you publish content on social media consistently?",
          opts: ["Yes", "No"],
        },
        {
          q: "What is your biggest challenge?",
          opts: ["Get more clients", "Improve digital presence", "Automate processes", "Sell more", "Other"],
        },
      ],
      resultTitle: "Your business has untapped digital opportunities.",
      resultDesc: "Request your complete Free Digital Diagnostic and discover exactly what you can improve to attract more customers.",
      formTitle: "Request your complete diagnostic",
      fields: {
        name: "Full name",
    ...
    process: {
      title: "How we work",
      steps: [
        { title: "You request the diagnostic", desc: "Fill out the form and tell us about your business." },
    ...
    finalcta: {
      ...
      cta: "Request Free Digital Diagnostic",
    },
    footer: {
      tagline: "Digital systems for businesses that want to grow.",
      links: ["Services", "Diagnostic", "Portfolio", "Contact"],
...
const sectorIcons = [Stethoscope, Star, Scale, PawPrint, Scissors, UtensilsCrossed, Building2, ShoppingBag];
    ...
    <div className="min-h-screen bg-[#0D0F1C] text-white overflow-x-hidden">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              ...
              <button
                onClick={() => scrollTo("diagnostico")}
                className="mt-2 bg-orange-500 text-white font-semibold py-2 rounded-lg"
              >
                {text.nav.cta}
              </button>
            </motion.div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            {["Marketing Digital", "IA & Automatización", "CRM & Prospectos", "SEO Local"].map((item) => (
                    ...
                    {!showForm ? (
                      ...
                      >
                        <div className="bg-orange-500/10 border border-orange-500/25 rounded-2xl p-5 mb-8">
                          <h3 className="font-bold text-orange-300 mb-1">{text.diagnostic.resultTitle}</h3>
                        ...
                        <form onSubmit={handleFormSubmit} className="grid sm:grid-cols-2 gap-4">
                          {Object.entries(text.diagnostic.fields).map(([key, label]) => {
                            const isTextarea = key === "message";
                            const isLast = key === "message";
                            return (
                              <div key={key} className={isLast ? "sm:col-span-2" : ""}>
                                {isTextarea ? (
                                  <textarea
                                    placeholder={label}
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {text.services.packages.map((pkg, i) => (
                    <motion.div
                      ...
                      className={`relative bg-[#131627] border rounded-3xl p-7 flex flex-col ${
                    ...
                    >
                      ...
                      <span className="text-xs text-orange-400 font-semibold mb-2">{pkg.tag}</span>
                      <h3 className="text-xl font-bold mb-5" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                        {pkg.name}
                      </h3>
                      ...
                      <button
                        ...
                        className={`w-full py-3 rounded-xl font-semibold text-sm transition-all ${
                          (pkg as { popular?: boolean }).popular
                            ...
                            : "border border-white/15 hover:border-orange-500/50 text-white/80 hover:text-white"
                        }`}
                      >
                        {text.services.cta}
                      </button>
          ...
          {(() => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-gradient-to-br from-[#1a1033] via-[#131627] to-[#0f1a2e] border border-blue-500/20 rounded-3xl p-8 sm:p-12 overflow-hidden"
              >
                ...
                <div className="relative z-10 flex flex-col lg:flex-row gap-8 items-start lg:items-center justify-between">
                  <div className="flex-1">
                    <span className="inline-block bg-blue-500/15 border border-blue-500/30 text-blue-400 text-xs font-bold px-3 py-1 rounded-full mb-4">
                      {text.highticket.tag}
                    </span>
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                      {text.highticket.title}
                    </h2>
                    <p className="text-white/65 text-lg max-w-xl leading-relaxed mb-6">
                      {text.highticket.desc}
                    </p>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-2 gap-4">
                    {text.authority.stats.map((stat, i) => (
                      <div
                        key={i}
                        data-testid={`stat-authority-${i}`}
                        className="bg-[#131627] border border-white/8 rounded-2xl p-6 text-center"
                      >
                        <div className="text-3xl font-bold text-orange-400 mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                          {stat.value}
                        </div>
            ...
            return (
              <motion.div ref={ref} variants={stagger} initial="hidden" animate={inView ? "visible" : "hidden"}>
                <motion.div variants={fadeUp} className="text-center mb-12">
                  ...
                  <p className="text-white/55">{text.portfolio.subtitle}</p>
                </motion.div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {(() => {
            ...
            return (
              <motion.div
                ...
                animate={inView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.7 }}
                className="relative bg-gradient-to-br from-orange-900/30 via-[#131627] to-blue-900/20 border border-orange-500/20 rounded-3xl p-10 sm:p-16 overflow-hidden"
              >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-col gap-2 text-sm text-white/50">
                ...
                <span className="flex items-center gap-2"><Mail size={14} className="text-orange-400" /> contacto@coimagenmedia.com</span>
                <span className="flex items-center gap-2"><Phone size={14} className="text-orange-400" /> +52 664 000 0000</span>
              </div>
            </div>
            <div>
              ...
              <div className="flex gap-3">
                {["Facebook", "Instagram", "LinkedIn", "TikTok"].map((s) => (
                  <a
                    ...
                    className="w-9 h-9 bg-white/5 hover:bg-orange-500/20 border border-white/10 hover:border-orange-500/30 rounded-lg flex items-center justify-center transition-all"
                    title={s}
                  >
                    <MessageSquare size={14} className="text-white/50 hover:text-orange-400" />
                  </a>
                ))}
              </div>
            </div>
      ...
      >
        <Phone size={18} />
        <span className="text-sm hidden group-hover:inline-block transition-all">
          {text.whatsapp}
        </span>
      </a>
    </div>
