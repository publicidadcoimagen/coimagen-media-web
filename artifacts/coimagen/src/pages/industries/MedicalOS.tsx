...
const content = {
  ...
  modules: [
    { icon: "🌐", name: { es: "Landing médica", en: "Medical landing page" } },
    { icon: "🗺️", name: { es: "Google Maps / SEO", en: "Google Maps / SEO" } },
    { icon: "📋", name: { es: "Formulario de pacientes", en: "Patient form" } },
    { icon: "📅", name: { es: "Agenda", en: "Scheduling" } },
    { icon: "👥", name: { es: "CRM de pacientes", en: "Patient CRM" } },
    { icon: "💬", name: { es: "Seguimiento WhatsApp", en: "WhatsApp follow-up" } },
    { icon: "📊", name: { es: "Reportes", en: "Reports" } },
    { icon: "✍️", name: { es: "Contenido médico", en: "Medical content" } },
  ],
  ctaLabel: {
