...
export default function CoimagenOS() {
  ...
  useEffect(() => {
    document.title = isEs ? "Case Study: Coimagen OS — Coimagen" : "Case Study: Coimagen OS — Coimagen";
    window.scrollTo(0, 0);
  }, [isEs]);
    ...
    <div className="min-h-screen bg-[#06060f] pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="glass border border-[var(--c-cyan)]/20 rounded-2xl p-8 text-center">
          <h2 className="text-xl font-black text-white mb-3">{isEs ? "¿Quieres tu propio sistema operativo?" : "Want your own operating system?"}</h2>
          <p className="text-[var(--c-muted)] text-sm mb-5">{isEs ? "Implementamos una versión adaptada a tu industria y negocio." : "We implement a version adapted to your industry and business."}</p>
