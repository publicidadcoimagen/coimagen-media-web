...
const faqs = [
  ...
  {
    es: { q: "¿Cómo puedo contactarlos?", a: "Por WhatsApp al +52 664 476 9223, por correo a info@coimagenmedia.com, o agendando una sesión estratégica gratuita desde nuestra página." },
